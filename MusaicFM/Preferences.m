...
- (instancetype)initWithCoder:(NSCoder *)decoder {
  ...
  if (self) {
    ...
    self.deezerUserId = [decoder decodeObjectForKey:@"deezerUserId"];
  }
  return self;
}
...
- (void)encodeWithCoder:(NSCoder *)encoder {
  ...
  [encoder encodeObject:self.deezerUserId forKey:@"deezerUserId"];
...
- (void)synchronize {
  ScreenSaverDefaults *defaults = [ScreenSaverDefaults
      defaultsForModuleWithName:@"com.obrhoff.musaicfm.preferences"];
